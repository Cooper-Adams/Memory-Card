...
import musicTitles from './assets/sounds/_musicTitles'
...
const App = (props) => {
    ...
    const [dbdHS, setDBDHS] = useState(0)
    ...
    return (
        <div className='react-app'>
            ...
            <div className='volume-div'>
                <h2 className='volume-title'>Now Playing: {musicTitles[sagaName]}</h2>
